...
heights_src = rio.open(heights_tif_path)
colour_tif_path = (
    Path(__name__).absolute().parent.parent.joinpath("tasmania", "colour.tif")
)
colour_src = rio.open(colour_tif_path)
CANVAS_WIDTH = 30978
CANVAS_HEIGHT = 30978

# heights_data = heights_src.read(1)
# heights_data -= heights_data.min()
# max_height_value = heights_data.max()
min_height_value = -86
